...
conf = 0.7
threshold = 0.3
# detectable_item = ["bird", "cat", "dog", "horse", "sheep",
#                    "cow", "elephant", "bear", "zebra", "giraffe", "human"]
    ...
    if ret:
        ...
        if len(idxs) > 0:
            ...
            for i in idxs.flatten():
                # if LABELS[classIDs[i]] in detectable_item:
                    ...
                    serialprint(LABELS[classIDs[i]])
                    engine.say(LABELS[classIDs[i]] + " Detected")
                    engine.runAndWait()
